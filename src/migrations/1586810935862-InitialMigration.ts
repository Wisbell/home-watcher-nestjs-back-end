...
export class InitialMigration1586810935862 implements MigrationInterface {
    name = 'InitialMigration1586810935862'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "incident" ("id" SERIAL NOT NULL, "dateCreated" character varying NOT NULL, "text" character varying NOT NULL, "imageId" integer NOT NULL, CONSTRAINT "REL_edcf86e779912ade2aaa403d6a" UNIQUE ("imageId"), CONSTRAINT "PK_5f90b28b0b8238d89ee8edcf96e" PRIMARY KEY ("id"))`, undefined);
